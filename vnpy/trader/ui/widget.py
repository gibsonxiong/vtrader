...
class TradesCell(BaseCell):
    ...
    def set_content(self, content: Any, data: Any) -> None:
        ...
        for trade in content:
            text += f"{trade.offset.value}{trade.direction.value} {trade.price} {trade.volume} | "
    ...
    def update_with_cell(self, cell: BaseCell) -> None:
        ...
        if isinstance(data, PositionData):
            ...
            self.offset_combo.setCurrentIndex(
                self.offset_combo.findText(Offset.OPEN.value)
            )
