...
from vnpy.api.vnpy_rest import RestClient, Request, Response
...
class HuobiUsdtTradeWebsocketApi(HuobiWebsocketApiBase):
    ...
    def subscribe(self) -> None:
        ...
        req: dict = {
            "op": "sub",
            "topic": f"accounts_unify.USDT"
        }
        self.send_packet(req)

        # req: dict = {
        #     "op": "sub",
        #     "topic": f"accounts_unify.BTC"
        # }
        # self.send_packet(req)

        # req: dict = {
        #     "op": "sub",
        #     "topic": f"accounts_unify.USDC"
        # }
        # self.send_packet(req)
    ...
    def on_order(self, data: dict) -> None:
        ...
        for d in trades:
            trade: TradeData = TradeData(
                ...
                trade_time=generate_datetime(d["created_at"] / 1000),
                gateway_name=self.gateway_name,
            )
