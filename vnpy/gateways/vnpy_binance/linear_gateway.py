...
from vnpy.api.vnpy_rest import Request, RestClient, Response
from vnpy.trader.setting import SETTINGS
from vnpy.api.vnpy_websocket import WebsocketClient


# Timezone constant
UTC_TZ = ZoneInfo(SETTINGS["database.timezone"])
...
DIRECTION_OFFSET2BINANCE: dict[Direction, str] = {
    Direction.LONG: "LONG",
...
class BinanceLinearGateway(BaseGateway):
    ...
    def query_history(self, req: HistoryRequest, callback: Callable | None) -> list[BarData]:
        """
        ...
        """
        return self.rest_api.query_history(req, callback)
    ...
    def get_contract_by_symbol(self, symbol: str) -> ContractData | None:
        ...
        Parameters:
            symbol: VeighNa symbol (e.g. "BTC_SWAP")
...
class RestApi(RestClient):
    ...
    def on_query_time(self, data: dict, request: Request) -> None:
        ...
        self.gateway.write_log(f"服务器时间已更新, 本地时间偏移: {self.time_offset}ms")
    ...
    def on_query_account(self, data: dict, request: Request) -> None:
        ...
        self.gateway.write_log("Account data接收成功")
    ...
    def on_query_position(self, data: list, request: Request) -> None:
        ...
        for d in data:
            ...
            position: PositionData = PositionData(
                ...
                direction=Direction.LONG if d["positionSide"] == "LONG" else Direction.SHORT,
        ...
        self.gateway.write_log("仓位信息查询成功")
...
class UserApi(WebsocketClient):
    ...
    def on_connected(self) -> None:
        ...
        """
        self.gateway.write_log("User websocket连接成功")
        ...
        for pos_data in packet["a"]["P"]:
            if pos_data["ps"] != "BOTH":
                ...
                position: PositionData = PositionData(
                    symbol=contract.symbol,
                    exchange=Exchange.BINANCE,
                    direction=Direction.LONG if pos_data["ps"] == "LONG" else Direction.SHORT,
                    volume=abs(volume),
    ...
    def on_order(self, packet: dict) -> None:
        ...
        trade: TradeData = TradeData(
            ...
            volume=trade_volume,
            trade_time=generate_datetime(ord_data["T"]),
            gateway_name=self.gateway_name,
        )
    ...
    def on_disconnected(self, status_code: int, msg: str) -> None:
        ...
        """
        self.gateway.write_log(f"User API失去连接, code: {status_code}, msg: {msg}")
    ...
    def on_error(self, e: Exception) -> None:
        ...
        """
        self.gateway.write_log(f"User websocket出现异常: {e}")
...
class MdApi(WebsocketClient):
    ...
    def on_connected(self) -> None:
        ...
        """
        self.gateway.write_log("MD websocket连接成功")
    ...
    def on_disconnected(self, status_code: int, msg: str) -> None:
        ...
        Parameters:
            ...
            msg: Disconnection message
        """
        self.gateway.write_log(f"MD API失去连接, code: {status_code}, msg: {msg}")
    ...
    def on_error(self, e: Exception) -> None:
        ...
        Parameters:
            e: The exception that was raised
        """
        self.gateway.write_log(f"MD websocket出现异常: {e}")
...
class TradeApi(WebsocketClient):
    ...
    def send_order(self, req: OrderRequest) -> str:
        ...
        if req.direction == Direction.LONG:
            params["side"] = "BUY" if req.offset == Offset.OPEN else "SELL"
        else:
            params["side"] = "SELL" if req.offset == Offset.OPEN else "BUY"
    ...
    def on_connected(self) -> None:
        ...
        is successfully established. It logs the connection status.
        """
        self.gateway.write_log("Trade websocket连接成功")
    ...
    def on_disconnected(self, status_code: int, msg: str) -> None:
        ...
        Parameters:
            ...
            msg: Disconnection message
        """
        self.gateway.write_log(f"Trade API失去连接, code: {status_code}, msg: {msg}")
    ...
    def on_error(self, e: Exception) -> None:
        ...
        Parameters:
            e: The exception that was raised
        """
        self.gateway.write_log(f"Trade websocket出现异常: {e}")
