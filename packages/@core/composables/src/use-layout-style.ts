...
import type { VisibleDomRect } from '@vtrader-core/shared/utils';
...
} from '@vtrader-core/shared/constants';
import { getElementVisibleRect } from '@vtrader-core/shared/utils';
