...
import type { TabDefinition } from '@vtrader/types';

import type { IContextMenuItem } from '@vtrader-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@vtrader/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { $t, useI18n } from '@vtrader/locales';
import { getTabKey, useAccessStore, useTabbarStore } from '@vtrader/stores';
import { filterTree } from '@vtrader/utils';
