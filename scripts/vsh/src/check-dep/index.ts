...
import { getPackages } from '@vtrader/node-utils';
...
const DEFAULT_CONFIG = {
  ...
  ignoreMatches: [
    ...
    '@vtrader/tsconfig',
    '@vtrader/vite-config',
    '@vtrader/tailwind-config',
    '@types/*',
    '@vtrader-core/design',
  ],
  // 需要忽略的包
  ignorePackages: [
    '@vtrader/backend-mock',
    '@vtrader/commitlint-config',
    '@vtrader/eslint-config',
    '@vtrader/node-utils',
    '@vtrader/prettier-config',
    '@vtrader/stylelint-config',
    '@vtrader/tailwind-config',
    '@vtrader/tsconfig',
    '@vtrader/vite-config',
    '@vtrader/vsh',
